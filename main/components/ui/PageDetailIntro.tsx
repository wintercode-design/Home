...
interface PageDetailIntroProps {
  title: string;
  img?: string;
...
const PageDetailIntro = ({
  title,
  img,
  links,
  className,
}: PageDetailIntroProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className="flex flex-col gap-4 w-fit justify-center items-center text-center p-8"
        variants={containerVariants}
      >
...
export default PageDetailIntro;
