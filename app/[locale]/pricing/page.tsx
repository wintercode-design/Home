  ...
  return (
    <main>
      <Container className="py-[50px] flex flex-col justify-center items-center">
        <div className="flex justify-between gap-4 items-start w-full py-6 max-w-[900px]">
          <p>Web Development Packages Overview</p>

          <div className="flex flex-col p-4 gap-3 w-full max-w-[472px] bg-white text-black">
            <caption>{"Important Note"}</caption>
            <h5>
              {"For any feature not mentioned here feel free to contact me"}
            </h5>
          </div>
        </div>
        <table>
                ...
                <tr key={index}>
                  ...
                  <td className="border border-black px-2 py-4 bg-white text-black">
                    <span className="flex gap-2">
                      {feature.start.some((x) => x == "no") && <X size={16} />}
                  ...
                  <td className="border px-2 py-4">
                    <span className="flex gap-2">
                      {feature.pro.some((x) => x == "no") && <X size={16} />}
                  ...
                  <td className="border border-black px-2 py-4 bg-white text-black">
                    <span className="flex gap-2">
                      {feature.busi.some((x) => x == "no") && <X size={16} />}
